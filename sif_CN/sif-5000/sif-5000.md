...
| 20   | （存款盒子发行期）利息取回 | 用钱包 B 取回利息，并在此注入,[帮助文档](https://github.com/hashgard/hashgard/blob/develop/docs/translations/zh/cli/hashgardcli/box/interest-fetch.md) | 提交两次交易 tx   | 100  |
