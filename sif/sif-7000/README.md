...
| 5    | Redelegate   | With Wallet B, transfer the 10 GARD you delegated to your own validator to the Other  validator[list](https://www.gardplorer.io/validator) with redelegate function,[doc](https://github.com/hashgard/hashgard/blob/develop/docs/cli/hashgardcli/stake/redelegate.md) | Submit transaction tx | 100  |
