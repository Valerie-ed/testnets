...
| ---- | ------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ---- |
| 1    | Run a full node          | Run a full node, join testnet, and create six wallets (named Wallet A / B / C / D / E / F ,[DOC](../docs/README.md) | submit nodes IP, and ensure that the corresponding port is accessible, the default is 26657 port, http://${your_ip}:26657/status | 200  |
